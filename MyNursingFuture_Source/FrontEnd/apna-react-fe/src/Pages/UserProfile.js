...
class UserProfile extends Component {
  ...
  handleChangeInput = function (e) {
    console.log('be4', this.state.inputs);
    ...
    console.log('after', this.state.inputs);
  }
  ...
  handleSaveChange = function () {
    // console.log("outside");
    if (this.props.user.name != this.state.inputs.name || this.props.user.email != this.state.inputs.email || this.props.user.salary != this.state.inputs.salary) {
      // console.log(this.state);
      this.props.saveChangeToProfile(this.state.inputs.name, this.state.inputs.email, this.state.inputs.salary);
      ...
      return (
       ...
       // <div className="row">
        ...
        //         <input type="text" value={this.state.inputs.newPassword} name="newPassword" placeholder="New Password" onChange={this.handleChangeInput} /> */}
              <div className="col-12">
                <h1>Minimum Salary Expectation: </h1>
              </div>
              {this.state.salaryEditing &&
                <div className="col-12">
                  <div className="row">
                    <div className="col-6">
                      <div className="input-block">
                        <input type="text" value={this.state.inputs.salary} name="salary" placeholder="Minimum Salary" onChange={this.handleChangeInput} />
                      </div>
                    </div>
                    <div className="col-6">
                      <button className="btn" onClick={() => { this.handleToggleEditing('salary'); this.handleSaveChange(); }}>Save</button>
                    </div>
                  </div>
                </div>
              }
              {!this.state.salaryEditing &&
                <div className="col-12">
                  <div className="row">
                    <div className="col-6"><p>{this.state.inputs.salary}</p></div>
                    {!this.props.user.apnaUser && <div className="col-6"><button className="btn" onClick={() => { this.handleToggleEditing('salary') }}>Edit</button></div>}
                  </div>
                </div>
              }
            </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    saveChangeToProfile: function (name, email, salary) {
      console.log('saveChangtt', name, email, salary);
      dispatch(fetchUpdateUserDetails(name, email, salary));
    },
